...
namespace WhiteSpace.Components.Animation
{
    ...
    {
        private static Dictionary<string, Animator> animators = new Dictionary<string, Animator>();
        ...
        public static Animator loadAnimator(TextureRegion regionToAnimate, string animatorName, int animationInterval)
        {
            ...
            animators[animatorName] = animatorToReturn;
        ...
        {
            return this.MemberwiseClone() as Animator;
        }
        ...
        {
            this.play = false;
            this.activeAnimation.currentFrame = 0;
        }
