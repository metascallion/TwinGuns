...
namespace WhiteSpace.GameObjects
{
    ...
    public class TestRotationGameObject <StateType> : GameObject <StateType> where StateType : struct
    {
        ...
        public void testMovement(GameTime time)
        {
            ...
            {
                controller.move(new Vector2(15.0f, 0));
    ...
    public class TestRotationGameObjectType2<StateType> : GameObject<StateType> where StateType : struct
    {
        public TextureRegion<StateType> unitTexture;
        public float speed = 0.5f;
        Animator<StateType> animator;
        ...
        public TestRotationGameObjectType2(StateType type, Transform transform)
            : base(type, transform)
        {
        ...
        public TestRotationGameObjectType2(Transform transform, Texture2D texture)
            : base(transform)
        {
            unitTexture = new TextureRegion<StateType>(transform, texture);
            animator.AnimationSpeed = 10;
        ...
        public void testMovement(GameTime time)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.A) || Keyboard.GetState().IsKeyDown(Keys.D) || Keyboard.GetState().IsKeyDown(Keys.Right) || Keyboard.GetState().IsKeyDown(Keys.Up) || Keyboard.GetState().IsKeyDown(Keys.Down))
            {
                animator.playAnimation("Run", true);
            }
